...
<div id="node-<?php print $node->nid; ?>" style="margin-top:30px;" class="<?php print $classes; ?> clearfix post large" <?php print $attributes; ?>>
    ...
    <div class="post-format">
        <?php
        $time = strtotime($content['field_excelpoint_ongoing_events']['#items'][0]['value2']);
        print date("d",$time)."<br>";
        
        ?>
        <h4><?php print date('F d, Y',$content['field_excelpoint_ongoing_events']['#items'][0]['value']); ?></h4>
        <h2><?php print date('d',$content['field_excelpoint_ongoing_events']['#items'][0]['value2']); ?></h2>
    </div>
